...
export function heuristicGroup(files) {
...
export function mergeAIGroups(heuristic, aiResult, allFiles) {
    ...
    return orderGroups(heuristic.map((g) => ({
        files: g.files,
...
function orderGroups(groups) {
    return [...groups].sort((a, b) => (TYPE_ORDER[a.type] ?? 99) - (TYPE_ORDER[b.type] ?? 99));
}
